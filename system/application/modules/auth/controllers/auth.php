...
class auth extends MY_Controller
{
	...
	function login()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
            ...
            $this->_render('auth/login_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
		...
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->create_user(
					...
					//$this->addToTitle($this->config->item('website_name'));
            ...
            $this->_render('auth/register_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function send_again()
	{
		if (!$this->tank_auth->is_logged_in(FALSE)) {							// not logged in or activated
            ...
            $this->_render('auth/send_again_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function forgot_password()
	{
		if ($this->tank_auth->is_logged_in()) {									// logged in
            ...
            $this->_render('auth/forgot_password_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function reset_password()
	{
        ...
        $this->_render('auth/reset_password_form', $data, __FUNCTION__, __FUNCTION__);
	}
	...
	function change_password()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
            ...
            $this->_render('auth/change_password_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function change_email()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
            ...
            $this->_render('auth/change_email_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function unregister()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
            ...
            $this->_render('auth/unregister_form', $data, __FUNCTION__, __FUNCTION__);
		}
	}
	...
	function _show_message($message)
	{
        ...
        $this->template->current_view = 'auth/general_message';
