...
class Template {
	...
	{	
        ...
        // get view from modules/[mod]/views/[mod]/[view] - compliant with HMVC
        $this->ci->router->directory = preg_replace('#controllers#i', 'views', $this->ci->router->directory);
	...
	/**
	 * Makes it easy to get information saved by set
     * by Daniel Michalski
	 *
	 * @access public
	 * @param string $name. (default: '')
